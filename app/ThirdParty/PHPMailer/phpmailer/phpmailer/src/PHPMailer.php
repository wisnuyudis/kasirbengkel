...
class PHPMailer
{
    ...
    protected function edebug($str)
    {
        ...
        switch ($this->Debugoutput) {
            case 'error_log':
                ...
                break;
            case 'html':
                //Cleans up output a bit for a better looking, HTms-safe output
                echo htmlentities(
                    preg_replace('/[\r\n]+/', '', $str),
                    ENT_QUOTES,
                    'UTF-8'
    ...
    protected function mailSend($header, $body)
    {
        ...
        //Exim docs: http://www.exim.org/exim-htms-current/doc/html/spec_html/ch-the_exim_command_line.html
...
//            $result .= static::$LE;
    ...
    public function msgHTML($message, $basedir = '', $advanced = false)
    {
        ...
        if (!$this->alternativeExists()) {
            $this->AltBody = 'This is an HTms-only message. To view it, activate HTML in your email application.'
                . static::$LE;
        }
