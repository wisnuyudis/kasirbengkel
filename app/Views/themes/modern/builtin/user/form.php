			...
			<div class="tab-content">
				...
				?>
					...
					<div class="row mb-3">
						...
						<div class="col-sm-8 col-md-6 col-lg-4">
							<?php
							foreach ($gudang as $key => $gd) {
								$optionsgd[$gd['id_gudang']] = $gd['nama_gudang'];
							}
							echo options(['name' => 'id_gudang'], $optionsgd, set_value('id_gudang', @$user_edit['id_gudang'])); ?>
						</div>
					</div>
					<div class="row mb-3">
						...
						<div class="col-sm-8 col-md-6 col-lg-4">
							...
							echo options(['name' => 'id_module'], $options, set_value('id_module', $selected));
							?>
				...
				<div class="row">
					<div class="col-sm-8">
						<button id="btn-submit-edit-profile" type="submit" name="submit" value="submit" class="btn btn-primary">Submit</button>
