	...
	<div class="card-body">
		...
		<form method="post" action="" class="form-horizontal" enctype="multipart/form-data">
			<div class="tab-content" id="myTabContent">
				...
				<div class="form-group row mb-3">
					<label class="col-sm-3 col-md-2 col-lg-3 col-xl-2 col-form-label">Nama Sales</label>
					<div class="col-sm-5" style="position:relative">
						<select style="width: 100%;" name="id_sales" class="sales select2">
							<?php
						...
						<input type="hidden" name="nama_sales" id="nama_sales" />
					</div>
				</div>
				<div class="form-group row mb-3">
					<label class="col-sm-3 col-md-2 col-lg-3 col-xl-2 col-form-label">Jenis Harga</label>
					<div class="col-sm-5" style="position:relative">
						<select style="width: 100%;" name="id_jenis_harga" class="jenis_harga select2">
							<?php $sl = "";
						...
						<input type="hidden" name="nama_jenis_harga" id="nama_jenis_harga" />
					</div>
				</div>
				<div class="form-group row mb-3">
