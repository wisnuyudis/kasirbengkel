			...
			<ul>
				<li class="dropdown">
					<a href="#" class="icon-link" data-bs-toggle="dropdown" aria-expanded="false">
						...
						<span class="badge rounded-pill badge-notification position-absolute bg-danger translate-middle" style="font-size:10px; top:20px">
							<?php if ($get['tujuhari'] + $get['sebulan'] > 99) {
								echo "99+";
							} else {
								echo $get['tujuhari'] + $get['sebulan'];
							} ?>
						</span>
					</a>
					<div class="dropdown-menu p-3">
						...
						<div class="d-flex justify-content-between align-items-start text-nowrap py-2">
							<?php if ($get['tujuhari'] >= 1) { ?>
								<a title="Daftar hiutang Akan Jatuh Tempo" href="<?php echo base_url('pembelian/tempo/tujuhari') ?>" class="pe-2">Jatuh tempo dalam 7 hari</a>
								<span class="badge rounded-pill bg-success"><?php echo $get['tujuhari']; ?></span>
							<?php } else { ?>
								<span class="pe-2">Jatuh tempo dalam 7 hari</span>
								<span class="badge rounded-pill bg-success">0</span>
							<?php } ?>
						</div>
						<div class="d-flex justify-content-between align-items-start text-nowrap py-2">
							<?php if ($get['sebulan'] >= 1) { ?>
								<a title="Daftar Hutang Lewat Jatuh Tempo" href="<?php echo base_url('pembelian/tempo/sebulan') ?>" class="pe-2">Lewat 30 hari</a>
								<span class="badge rounded-pill bg-danger"><?php echo $get['sebulan']; ?></span>
							<?php } else { ?>
								<span class="pe-2">Lewat 30 hari</span>
