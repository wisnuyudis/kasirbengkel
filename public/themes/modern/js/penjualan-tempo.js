...
jQuery(document).ready(function () {
	...
	$('#btn-excel').click(function() {
		...
		url = base_url + 'penjualan-tempo/ajaxExportExcel?start_date=' + start_date + '&end_date=' + end_date;
		fetch(url)
		  .then(resp => resp.blob())
		  .then(blob => {
	...
	$('#btn-pdf').click(function() {
		...
		url = base_url + 'penjualan-tempo/ajaxExportPdf?start_date=' + start_date + '&end_date=' + end_date + '&ajax=true';
		fetch(url)
		  .then(resp => resp.blob())
		  .then(blob => {
				$this.prop('disabled', false);
	...
	function update_data() 
	{
		...
		$.ajax({
			url: base_url + 'penjualan-tempo/ajaxGetResumePenjualanTempo?start_date=' + start_date + '&end_date=' + end_date + '&jatuh_tempo=' + jatuh_tempo,
			dataType: 'JSON',
			success: function(data) {
		...
		settings.ajax.url = base_url + 'penjualan-tempo/getDataDTPenjualanTempo?start_date=' + start_date + '&end_date=' + end_date + '&jatuh_tempo=' + jatuh_tempo;
		dataTables.destroy();
